...
public class Prospector : MonoBehaviour {
    ...
    void Start() {
        ...
        Deck.Shuffle(ref deck.cards); //Shuffles deck by reference
    ...
    //Draw function will pull a single card from drawPile and return it
    ...
    void LayoutGame()
    {
        ...
        foreach (SlotDef tSD in layout.slotDefs)
        {
            ...
            // appears as _Deck in the Hierarchy when the scene is playin. 
        ...
        MoveToTarget(Draw()); //Set up initial target card
    ...
    void CheckForGameOver()
    {
        ...
        //No valid plays so the game is over. Call GameOver
        GameOver(false);
    }
    ...
    void GameOver(bool won)
    {
        ...
        //  SceneManager.LoadScene("__Prospector_Scene_0"); No need for this

        //Reload the scene in reloadDelay seconds
        //Give the score a moment to travel
